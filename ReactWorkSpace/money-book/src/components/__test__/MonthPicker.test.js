...
describe('test MonthPicker component', () => {
  ...
  it('after click the button, dropdown should show, year list&month should have the correct items', () => {
  ...
  it('after the dropdown is show, click the document should close the dropdown', () => {
    let eventMap = {};
